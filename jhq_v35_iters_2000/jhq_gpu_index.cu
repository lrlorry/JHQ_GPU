#include "jhq_v35_iters_2000/jhq_gpu_index.cuh"
...
#endif
#include "jhq_v35_iters_2000/encode.cuh"
#include "jhq_v35_iters_2000/train_pq_gpu.cuh"
#include "jhq_v35_iters_2000/train_res_gpu.cuh"
#include "jhq_v35_iters_2000/search.cuh"
...
void JHQGpuIndex::train_residual_codebook_streamed(const float* h_x, int n)
{
    ...
    const char* ce = std::getenv("JHQ_RES_CHUNK");
    int C = ce ? std::atoi(ce) : 8;
    if (C < 1) C = 1;
    if (C > M_) C = M_;
...
// jhq_v35_iters_2000/jhq_gpu_index.cuh's Params::add_batch comment for
