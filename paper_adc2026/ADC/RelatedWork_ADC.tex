...
feeding a refinement stage, grouped lookup tables and a GPU layout. We share its
two-stage execution and grouped lookup; our contribution is measuring their
trade-off for JHQ's Cartesian codebook and calibrating its residual budget. We do not report it as a baseline: the available implementation exposes
