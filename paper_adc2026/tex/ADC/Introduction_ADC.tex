...
measured on six datasets. Two-group tables are fastest in 23 of 24 cells while
storing more than the alternatives that lose, and the budget rule buys
$1.05$--$2.77\times$ in ten of twelve held-out cells --- failing, measurably
and predictably, on the one dataset whose sufficient budget lies beyond the
tested grid.
