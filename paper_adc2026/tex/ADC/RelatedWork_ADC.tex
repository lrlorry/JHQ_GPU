...
identity for its distance table rather than choosing a different one. We also show
empirically that a smaller table can be slower once extra lookup instructions
dominate, most sharply between $G{=}4$ and $G{=}8$, which occupy the same
nominal footprint. Our claim is about exploiting a particular representation,
not about inventing small-table ADC in general.
