...
// v24 workspace — adds top_p, beam_size as runtime params.
struct SearchWorkspace {
    ...
    int top_p        = 4;   // candidates kept per visited block after PQ scan
    int beam_size    = 32;  // beam slots (must equal warp size for now)
...
void gpu_merge_pq_topk_v24(
    int nq, int n_pairs, int rerank_r, int top_p,
    SearchWorkspace& ws);
