...
// HBlock v24: v23 + oracle diagnostic + TOP_P/beam_size runtime sweep + no route D2H.
//
// v23 vs v24:
//   v23: TOP_P=4 compile-time constant, beam_size=32 fixed, route copies D2H
//   v24: top_p/beam_size are runtime params (sweep), route D2H removed,
//        oracle_recall() added for graph/PQ diagnostic
class HBlockIndex {
public:
    struct Params {
        int K1           = 16;
