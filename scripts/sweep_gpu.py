...
def main():
    ...
    ap.add_argument(
        "--version",
        choices=["v1_plain", "v2_topk", "v3_ivf", "v4_batched_query", "v5_cuda_graph"],
        default="v3_ivf",
    )
    ...
    if args.version in ("v3_ivf", "v4_batched_query", "v5_cuda_graph"):
    ...
    for val in sweep_values:
        if args.version in ("v3_ivf", "v4_batched_query", "v5_cuda_graph"):
            ...
            if args.version in ("v4_batched_query", "v5_cuda_graph"):
