#!/bin/bash
# Run hblock_v29 on both vogue-768 and arxiv-768
...
run_dataset() {
    ...
    local CSV=results/hblock_v29_${NAME}.csv
    echo "========================================"
...
echo ""
echo "All done. Results in results/hblock_v29_vogue.csv and results/hblock_v29_arxiv.csv"
