#!/usr/bin/env python3
"""
Sweep hblock_v20 recall-QPS tradeoff.
v20 = v17 + d_proj=128 routing + empty-centroid norm=1e30f fix.

Usage (run on server from /root/JHQ_GPU):
  python3 scripts/sweep_hblock_v20.py --dataset vogue
  python3 scripts/sweep_hblock_v20.py --dataset arxiv
  python3 scripts/sweep_hblock_v20.py --dataset both
"""
import argparse, csv, os, re, subprocess, sys

REPO   = os.path.expanduser("~/JHQ_GPU")
BINARY = os.path.join(REPO, "build", "demo_hblock_v20")
...
K1, K2, K3 = 16, 16, 16
BATCH      = 1024
D_PROJ     = 128   # v20: larger routing projection
K_TOPK     = 10
KM_ITERS   = 30
...
def main():
    ...
    for ds in targets:
        out = os.path.join(args.out_dir, f"hblock_v20_{ds}.csv")
