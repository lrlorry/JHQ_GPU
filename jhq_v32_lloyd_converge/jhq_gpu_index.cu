#include "jhq_v32_lloyd_converge/jhq_gpu_index.cuh"
...
#endif
#include "jhq_v32_lloyd_converge/encode.cuh"
#include "jhq_v32_lloyd_converge/train_pq_gpu.cuh"
#include "jhq_v32_lloyd_converge/train_res_gpu.cuh"
#include "jhq_v32_lloyd_converge/search.cuh"
...
#pragma omp parallel for schedule(dynamic)
    ...
    for (int m = 0; m < M_; ++m) {
        ...
        // The cap, not an iteration count: train_1d_kmeans already breaks on its
        // own fixed point. cpu/codebook.h's default of 25 is shared by every
        // version directory including the frozen v23, so it is passed here
        // rather than changed there.
        std::vector<float> cb = train_1d_kmeans(resid_m.data(), (int)resid_m.size(), Kr_, 1000);
...
// jhq_v32_lloyd_converge/jhq_gpu_index.cuh's Params::add_batch comment for
