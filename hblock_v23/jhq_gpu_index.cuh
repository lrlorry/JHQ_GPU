...
// HBlock v23: block-level graph with true block centroids.
//
// v22 vs v23:
//   v22 graph edge: cell-level k-NN (GEMM) → pair_start[neighbor_cell]
//   v23 graph edge: hierarchical candidate cells (C1/C2/C3) → actual nearest
//                   blocks by block centroid distance  (block_mean)
//
//   v22 entry:  pair_start[c123]  (storage-order artifact)
//   v23 entry:  top entry_per_cell blocks in each selected L3 cell by
//               ||q - block_cent[b]||²
class HBlockIndex {
public:
    struct Params {
