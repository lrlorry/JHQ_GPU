// demo_hblock_v43: SPACEV .i8bin subset evaluation for v43 (v42's mmap'd
// region files + graph-aware region packing -- see
// hblock_v43/jhq_gpu_index.cuh's class comment). Same CLI shape as
// demo_hblock_v42.cu, unchanged.
//
...
// build_region_layout() additionally prints the block graph's connected-
// component count -- graph-aware packing only helps within a component.
...
int main(int argc, char** argv)
{
    if (argc < 5) {
        fprintf(stderr,
            ...
            "(hblock_v43_<pid>_codes.region / _raw.region) -- point it at fast local\n"
    ...
    hblock_v43::HBlockIndex::Params p;
    ...
    hblock_v43::HBlockIndex idx(d, p);
