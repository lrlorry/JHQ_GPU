...
int main(int argc, char** argv)
{
    if (argc < 4) {
        fprintf(stderr,
            ...
            "         [k=10] [batch_size=1024] [d_proj=128] [rerank_r=64] [km_iters=30]\n",
            argv[0]);
        return 1;
    }
    ...
    int d_proj    = (argc > 12) ? atoi(argv[12]) : 128;
    ...
    hblock_v20::HBlockIndex::Params p;
    p.K1        = K1;
    p.K2        = K2;
    p.K3        = K3;
    p.ck1       = ck1;
    ...
    hblock_v20::HBlockIndex idx(d, p);
