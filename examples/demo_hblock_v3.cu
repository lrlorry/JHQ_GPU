...
int main(int argc, char** argv)
{
    if (argc < 4) {
        fprintf(stderr,
            ...
            "         [K1=64] [K2=128] [k1=32] [k2=32]\n"
            "         [ck1=8] [ck2=32] [ck3=256]\n"
    ...
    int k1         = (argc > 6)  ? atoi(argv[6])  : 32;
    int k2         = (argc > 7)  ? atoi(argv[7])  : 32;
    int ck1        = (argc > 8)  ? atoi(argv[8])  : 8;
    int ck2        = (argc > 9)  ? atoi(argv[9])  : 32;
    int ck3        = (argc > 10) ? atoi(argv[10]) : 256;
    int k          = (argc > 11) ? atoi(argv[11]) : 10;
    int batch_size = (argc > 12) ? atoi(argv[12]) : 1024;
    ...
    printf("K1=%d K2=%d k1=%d k2=%d ck1=%d ck2=%d ck3=%d k=%d batch=%d\n",
           K1, K2, k1, k2, ck1, ck2, ck3, k, batch_size);

    hblock_v3::HBlockIndex::Params p;
    p.K1         = K1;
    p.K2         = K2;
    p.k1         = k1;
    p.k2         = k2;
