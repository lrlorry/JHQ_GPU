...
int main(int argc, char** argv)
{
    ...
    hblock_v23::HBlockIndex idx(d, p);
    ...
    printf("\n=== Results ===\n");
    printf("graph_degree=%d  graph_budget=%d  entry_per_cell=%d\n",
           graph_degree, graph_budget, entry_per_cell);
    printf("Recall@%d : %.4f\n", k, rec);
