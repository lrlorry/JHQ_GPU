// demo_hblock_v39: SPACEV .i8bin subset evaluation for the v39 logical
// region partitioning + bounded GPU region pool build.
//
...
//
// search() already prints per-call region fetch-planning diagnostics
// (block_reuse-style request/unique/bytes-H2D counts) to stdout -- that is
// the actual v39 measurement; this demo just drives recall/QPS the same
// way the other hblock_vNN demos do.
...
int main(int argc, char** argv)
{
    ...
    hblock_v39::HBlockIndex idx(d, p);
