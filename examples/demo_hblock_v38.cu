// demo_hblock_v38: SPACEV .i8bin subset evaluation for the plain,
// fully-GPU-resident baseline (no region partitioning, no GPU pool).
// Exists specifically as the controlled comparison point for
// demo_hblock_v39/v42/v43.cu -- same CLI shape minus the region_*
// parameters, same dataset, same encoding pipeline.
...
int main(int argc, char** argv)
{
    ...
    hblock_v38::HBlockIndex::Params p;
    ...
    hblock_v38::HBlockIndex idx(d, p);
