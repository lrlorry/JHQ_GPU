...
int main(int argc, char** argv)
{
    if (argc < 4) {
        std::fprintf(stderr,
            ...
            "         [per_block_r=16] [batch=1024] [reps=3] [csv=]\n",
            argv[0]);
        return 1;
    }
    ...
    hblock_v40::HBlockIndex::Params p;
    ...
    hblock_v40::HBlockIndex index(base_reader.dim, p);
    ...
    std::printf("Adding %lld vectors from bvecs...\n", nbase);
    t0 = Clock::now();
