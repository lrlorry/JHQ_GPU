...
// HBlock v17: 3-level JL routing + PQ coarse scan + exact re-rank
//
// Key improvements over v14:
//  1. JL routing (64D) instead of JL (6D) → much higher recall
//  2. k-means centroids in 64D JL space → better cluster quality
...
public:
    struct Params {
        ...
        int d_proj     = 64;    // JL projection dimension
...
private:
    ...
    // JL random projection: Pi [d_proj, d], entries ~ N(0, 1/d_proj)
