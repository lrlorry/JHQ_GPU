...
// v26 workspace — beam_size is now a real sweep param (32/64/128 via template kernel).
// top_p removed: all leaf_size candidates are kept, global top-rerank_r selection.
...
// n_per_pair == leaf_size (all candidates kept per pair, global top-rerank_r selection)
void gpu_merge_pq_topk_v26(
