...
// route_queries_v21 takes valid-children bitmasks for L2 and L3 nodes.
// d_valid_c2[c1]       = 16-bit mask: bit k set if c1's k-th L2 child is non-empty
// d_valid_c3[c1*K2+c2] = 16-bit mask: bit k set if (c1,c2)'s k-th L3 child is non-empty
