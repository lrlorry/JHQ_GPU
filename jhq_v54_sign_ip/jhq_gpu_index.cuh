...
private:
    ...
    // JHQ_SIGN_IP's precondition, and the two constants it needs, read off the
    // centroids rather than assumed: the level magnitude a, and which
    // dimension each bit of a code byte carries.
    void   verify_sign_levels();
    float    sign_a_      = 0.0f;
    unsigned sign_bitmap_ = 0;
