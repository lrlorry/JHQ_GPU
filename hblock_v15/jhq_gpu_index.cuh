...
// ── HBlock v15: key-by-c1 routing dispatch ────────────────────────────────────
//
// v14: one global LUT (50MB, exceeds L2) → HBM-bound PQ kernel
// v15: per-ci compact LUT (n_ci × d × Kr ≈ 6.3MB) fits in L2 cache
//      Process K1 ci groups sequentially; each ci's LUT stays L2-resident.
class HBlockIndex {
public:
    struct Params {
        int K1         = 64;
