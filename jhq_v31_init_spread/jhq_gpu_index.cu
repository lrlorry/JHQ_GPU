#include "jhq_v31_init_spread/jhq_gpu_index.cuh"
...
#endif
#include "jhq_v31_init_spread/encode.cuh"
#include "jhq_v31_init_spread/train_pq_gpu.cuh"
#include "jhq_v31_init_spread/train_res_gpu.cuh"
#include "jhq_v31_init_spread/search.cuh"
...
void JHQGpuIndex::train_residual_codebook_streamed(const float* h_x, int n)
{
    ...
    for (int m0 = 0; m0 < M_; m0 += C) {
        ...
        CUDA_CHECK(cudaMemcpy(d_chunk, h_chunk.data(),
                              ...
                              cudaMemcpyHostToDevice));
        launch_residual_codebook_from_values(d_chunk, (long long)n * Ds_, cm, Kr_, 25,
...
// jhq_v31_init_spread/jhq_gpu_index.cuh's Params::add_batch comment for
